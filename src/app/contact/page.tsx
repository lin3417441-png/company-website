...
import { GROUP_ADDRESS, OG_IMAGE, SITE_CONFIG, WELLNESS_STORE, openingHoursSpec } from '@/lib/constants'
...
const faqItems = [
  { q: '如何预约挂号？', a: `您可以通过电话预约（${SITE_CONFIG.phone}），或直接到门诊前台挂号。` },
  { q: '中医院和门诊部有什么区别？', a: '中医院为二级中医院，功能齐全，可提供更全面的中医诊疗服务；门诊部为专业门诊部，各有特色专科。' },
  { q: '中医院/门诊可以代煎中药吗？', a: '各网点均提供专业中药代煎服务，支持门店自提与快递邮寄，方便您灵活取药。' },
  { q: '如何联系药食同源门店（食养小屋）', a: `地址：${WELLNESS_STORE.address} 电话：${WELLNESS_STORE.phone}` },
    ...
    <>
      ...
      <section id="wechat" className="section-padding bg-warm-100">
        <div className="container-custom mx-auto max-w-md text-center">
          <div className="mb-8">
            <Eyebrow variant="centered">微信关注</Eyebrow>
          </div>
