...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <AnimatedSection>
        <div className="flex h-full items-center justify-center rounded-md bg-primary-50 p-12 text-center">
          <div>
  ...
  return (
    <AnimatedSection direction="right">
      <form onSubmit={handleSubmit} className="rounded-md bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                type="text"
                required
                className="w-full rounded-md border border-warm-300 bg-warm-50 px-4 py-2.5 text-sm text-ink-900 outline-none transition-colors focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
            <div>
